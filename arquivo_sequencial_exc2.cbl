      ...
      *>Divisão de identificação do programa
       ...
       program-id. "arquivo_sequencial_exc2".
      ...
      *>   Declaração do arquivo
           select arqEstadoBrasil assign to "arqEstadoBrasil.txt"      *>assosiando arquivo lógico (nome dado ao arquivo dentro do pmg vom o arquivo fisico)
           ...
           file status is ws-fs-arqEstadoBrasil.                      *>file status (o status da ultima operação)
      ...
      *>----Variaveis de trabalho
       ...
       77  ws-fs-arqEstadoBrasil                   pic 9(02).

       01  ws-estadoBrasil occurs 27.
      ...
      *>------------------------------------------------------------------------
       ...
       *>******** ABRINDO O ARQUIVO **************
       *>  abrindo com  OPEN INPUT
           *> permite ler e escrever no arquivo

      *>    inicialização da tabela de estados

           open input arqEstadoBrasil.
           if ws-fs-arqEstadoBrasil <> 0 then
               move 1                                     to ws-msn-erro-ofsset
               move ws-fs-arqEstadoBrasil                 to ws-msn-erro-cod
               move "Erro ao abrir arq. arqEstadoBrasil " to ws-msn-erro-text
               perform finaliza-anormal
           end-if

           perform varying ws-ind-est from 1 by 1 until ws-fs-arqEstadoBrasil = 10
                                                     or ws-ind-est > 27

               read arqEstadoBrasil  into  ws-estadoBrasil(ws-ind-est)
               if  ws-fs-arqEstadoBrasil <> 0
               and ws-fs-arqEstadoBrasil <> 10 then
                   move 2                                     to ws-msn-erro-ofsset
                   move ws-fs-arqEstadoBrasil                 to ws-msn-erro-cod
                   move "Erro ao ler arq. arqEstadoBrasil "   to ws-msn-erro-text
                   perform finaliza-anormal
               end-if
           ...
           close arqEstadoBrasil.
           if ws-fs-arqEstadoBrasil <> 0 then
               move 3                                      to ws-msn-erro-ofsset
               move ws-fs-arqEstadoBrasil                  to ws-msn-erro-cod
               move "Erro ao fechar arq. arqEstadoBrasil " to ws-msn-erro-text
               perform finaliza-anormal
           end-if
